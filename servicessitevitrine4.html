...
<nav>
	<ul>
		...
		<li class="derru"><a href="index.html#menu" target="_blank">ACCUEIL</a></li>
        <ul class="derrulant"></ul>
      	    <li><a href="index.html#apropo">Information du site</a></li>
		 	<li><a href="index.html#projets">A qui est destine site</a></li>
		 	<li><a href="index.html#contact">Comment devenir membre</a></li>
		</li>

		<li class="derr"><a href="index.html#services" target="_blank">SERVICES</a></li>
        <ul class="derrulant"></ul>
      	    <li><a href="index.html#services">Communication</a></li>
		 	<li><a href="index.html#services">Strategie</a></li>
		 	<li><a href="index.html#services">Gestion</a></li>
		</li>

		<li class="der"><a href="index.html#apropo" target="_blank">A PROPO</a></li>
        <ul class="derrulant"></ul>
      	    <li><a href="index.html#membre">Information</a></li>
		 	<li><a href="index.html#membre">Notre Equipe</a></li>
		 	<li><a href="index.html#apropo">Comment faire</a></li>
		</li>

		<li class="d"><a href="index.html#projets" target="_blank">PROJETS</a></li>
		<ul class="derrulant"></ul>
      	    <li><a href="index.html#projets">En cours</a></li>
		 	<li><a href="index.html#projets">Futurs projets</a></li>
		 	<li><a href="index.html#actualite">Actualites</a></li>
		 	<li class="de"><a href="index.html#contact" target="_blank">CONTACT</a>
		</li>
	</ul>
...
<h6>COMME TOUS LES AUTRES MEMBRES DU SITE</h6>
<figure>
<a href= "btpplombier.jpg" target="_blank"><img src="parpaing.jpg" alt="photo"/>
...
<h6>COMME TOUS LES AUTRES MEMBRES DU SITE</h6>
<figure>
<a href= "business-info.jpg" target="_blank"><img src="business.jpg" alt="photo"/>
<img src="business-info.jpg" alt="photo"/>
<img src="modeleplan.jpeg" alt="photo"/>
<img src="poignedemain.jfif" alt="photo"/></a>
</figure>
